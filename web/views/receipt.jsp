...
<div class="container-lg">
    <%
        ...
        if (request.getAttribute("invoice") == null)
            invoice = new Invoice(-1, LocalDate.now(), -1, false);
        else
    ...
    <div>
        <form method="post">
            <label>Provider:&nbsp;
                <select class="form-control" name="partner">
                    <%
                        long fromPartners = -1;
                        if (request.getAttribute("fromPartnersToReceipt") != null)
        ...
        <form method="post">
            <button class="btn btn-warning" type="submit" name="clear">Save all and create new purchase invoice</button>
        </form>
    </div>
</div>
</body>
